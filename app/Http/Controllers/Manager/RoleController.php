...
class RoleController extends Controller
{
    ...
    public function store(RoleRequest $request)
    {
	    try {
            ...
            $request->session()->flash('sucesso',"$request->name Papél criado com sucesso!");
    ...
    public function destroy($id)
    {
        try {
            ...
            $request->session()->flash('sucesso',"$request->name Papél removido com sucesso!");
			return redirect()->route('roles.index');
	...
	public function updateSyncResources($role, Request $request)
	{
		try{
            ...
            $request->session()->flash('sucesso',"$request->name papel deletado com sucesso!");
